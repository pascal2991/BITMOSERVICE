		...
		<html> 
				<head>
                        ...
                        <title>Render fashion consulting  services to customers around</title>
                        <meta charset = "UTF-8" /> 
						<!-- <center> <style>body{background-image: url("buy-and-sell-millet/millet-bitmoservice2.jpg");}</style></center> -->
 ...
 <body>
   ...
   <header>
                ...
                <div class="decor">request-fashion
 ...
 <br />
	 ...
	 <a href="http://bitmoservice.com/request-and-render-fashion-consulting-service.php"> <input type="button" class="back" name="signin" value="Back"/></a>

                 
                    <div class="bod">
                            <strong class="name"> Welcome, <?=$_SESSION['username']?>!<br /></strong> <br />
                            <p id = 'name'>Your signup was successful.</p>
                    </div><br /><br /><br />

                           
                            <div>
								<h1 id="twoo">Log in for your best experience</h1>
						 </div>
				<br />
				
				<div class="long">
				      <?php if(isset($_GET['error'])):?>
						    <div class="error3"><?php echo $_GET['error'];?></div>
						<?php endif;?>
					 <form action="render-fashion-consulting-service-login1.php" method="post" class="iform">
								<input type="text" class="inputx" name="username" value="" placeholder="Username" required/> <br />
								<input type="password" class="inputx" name="password" value="" placeholder="Password" required/> <br />
								<input type="submit" class="input6" name="submit" value="Log In"/> <br /><br />
					 </form><br />
				</div>
				 
				 
								<br />
				 <h3 class="ac">  Don't have an account? Sign up here. It is simple and easy. </h3>
 
			<div >
							 
			<a  href="http://bitmoservice.com/render-fashion-consulting-service-signup.php" ><input type="button" class="sig" value="Sign Up"></a>
				...
				<div class="h10">
				 ...
				 <h6 id="h6">Make the call now. Your day just got better.</h6>
						</div>
