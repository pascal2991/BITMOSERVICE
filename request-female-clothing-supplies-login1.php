		...
		<html> 
				<head>
                        ...
                        <title>Request for female native wears on bitmoservice</title>
                        <meta charset = "UTF-8" /> 
 ...
 <br />
	 ...
	 <a href="http://bitmoservice.com/request-and-render-female-clothing-supplies.php"> <input type="button" class="back" name="signin" value="Back"/></a>
     ...
     <div class="bod">
            ...
            <p id = 'name'>Your signup was successful.</p>
				...
				<div class="long">
					 ...
					 <form action="request-female-clothing-supplies-login1.php" method="post" class="iform">
			...
			<a  href="http://bitmoservice.com/request-female-clothing-supplies-signup.php" ><input type="button" class="sig" value="Sign Up"></a>
