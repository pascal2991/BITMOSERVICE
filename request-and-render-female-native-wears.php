   ...
   <html> 
       ...
       <meta name="viewport" content="width=device-width, initial-scale=1">
       	<title>Request and render female native wears on bitmoservice</title>
	      <meta charset = "UTF-8" /> 
...
<div class= "contain1"> 
                ...
                <!-- <div class="right">
                            <img src = "buy-and-sell-female-fashion/female-fashion-bitmoservice.jpg"  width="width="110"" class="ideal" alt="miller-bitmoservice" >
                </div>  -->
<div class="input3w">

    <center><h1 class = "text3">Request and Render female native wears from your location.</h1><br /><br /><br /></center>

    <div><a href="http://bitmoservice.com/request-female-native-wears-login.php"><input id="input3x" type="button" value="Request" /></a></div>
    <br /><br/><br /><br /><br />

    <div><a href="http://bitmoservice.com/render-female-native-wears-login.php"><input id="input3x" type="button" value="Render" /></a></div>
    <br /><br/><br /><br /><br />
