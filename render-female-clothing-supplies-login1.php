		...
		<html> 
				<head>
                        ...
                        <title>Render female clothing supplies to customers around</title>
                        <meta charset = "UTF-8" /> 
 ...
 <br />
	 ...
	 <a href="http://bitmoservice.com/request-and-render-female-clothing-supply.php"> <input type="button" class="back" name="signin" value="Back"/></a>
				...
				<div class="long">
					 ...
					 <form action="render-female-clothing-supplies-login1.php" method="post" class="iform">
			...
			<a  href="http://bitmoservice.com/render-female-clothing-supplies-signup.php" ><input type="button" class="sig" value="Sign Up"></a>
