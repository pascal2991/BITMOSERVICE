		...
		<html> 
				<head>
                        ...
                        <title>Request for fashioon consulting services on bitmoservice</title>
                        <meta charset = "UTF-8" /> 
						<center> <style>body{background-image: url("buy-and-buy-rice/rice-bitmoservice2.jpg");}</style></center>
 ...
 <br />
     ...
     <div class="bod">
            ...
            <p id = 'name'>Your signup was successful.</p>
                        ...
                        <div>
								<h1 id="twoo">Login with your username and password.</h1>
						 </div>
				<br />
				
				<div class="long">
				      
					 <form action="request-fashion-consulting-service-login1.php" method="post" class="iform">
			...
			<a  href="http://bitmoservice.com/request-fashion-consulting-service-signup.php" ><input type="button" class="sig" value="Sign Up"></a>
