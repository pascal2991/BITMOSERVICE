   ...
   <html> 
     <head>
          ...
          <title>Request for male native wears and meet the designers</title>
	      <meta charset = "UTF-8" /> 
...
<br />
  ...
  <a href="http://bitmoservice.com/buy-rice-login.php"> <input type="button" class="back" name="signin" value="Back"/></a>
  ...
  <div>
	...
	<div class="long">
   <form action="request-male-native-wears-signup.php" method="post">
