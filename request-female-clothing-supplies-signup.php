   ...
   <html> 
     <head>
          ...
          <title>Request for female native wears and meet the designers</title>
	      <meta charset = "UTF-8" /> 
		  <style>body{background-image: url("buy-and-buy-rice/rice-bitmoservice2.jpg");}</style>
...
<br />
  ...
  <a href="http://bitmoservice.com/request-female-clothing-supplies-login.php"> <input type="button" class="back" name="signin" value="Back"/></a>
  ...
  <div>
	...
	<div class="long">
   <form action="request-female-clothing-supplies-signup.php" method="post">
