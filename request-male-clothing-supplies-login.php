		...
		<html> 
				<head>
                        ...
                        <title>Request for male clothing supplies on bitmoservice</title>
                        <meta charset = "UTF-8" /> 
 ...
 <br />
	 ...
	 <a href="http://bitmoservice.com/request-and-render-male-clothing-supplies.php"> <input type="button" class="back" name="signin" value="Back"/></a>
				...
				<div class="long">
					 ...
					 <form action="request-male-clothing-supplies-login.php" method="post" class="iform">
			...
			<a  href="http://bitmoservice.com/request-male-clothing-supplies-signup.php" ><input type="button" class="sig" value="Sign Up"></a>
