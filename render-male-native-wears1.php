...
<!DOCTYPE html>
   ...
   <html> 
       ...
       <meta name="viewport" content="width=device-width, initial-scale=1">
        <title>Render male native wears to costumers</title>
        <meta charset = "UTF-8" /> 
...
<br />
     ...
     <center><h1>Render male native wears from your location</h1></center><br /><br />
      
     <div class="long">
         <form action="render-male-native-wears1.php" method="post" enctype="multipart/form-data" autocomplete="off" class="">
