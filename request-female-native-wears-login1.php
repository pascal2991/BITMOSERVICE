 ...
 <br />
	 ...
	 <a href="http://bitmoservice.com/request-and-render-female-native-wears.php"> <input type="button" class="back" name="signin" value="Back"/></a>
     ...
     <div class="bod">
            ...
            <p id = 'name'>Your signup was successful.</p>
				...
				<div class="long">
					 ...
					 <form action="request-female-native-wears-login1.php" method="post" class="iform">
			...
			<a  href="http://bitmoservice.com/request-female-native-wears-signup.php" ><input type="button" class="sig" value="Sign Up"></a>
