...
<!DOCTYPE html>
   ...
   <html> 
       ...
       <meta name="viewport" content="width=device-width, initial-scale=1">
        <title>Render fashion consulting services from any  location</title>
        <meta charset = "UTF-8" /> 
...
<div class="bod">
     ...
     <center><h1>Render fashion consulting service from your location</h1></center><br /><br />
      
     <div class="long">
         <form action="render-fashion-consulting-service.php" method="post" enctype="multipart/form-data" autocomplete="off" class="">
