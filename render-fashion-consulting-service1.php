...
<!DOCTYPE html>
   ...
   <html> 
       ...
       <meta name="viewport" content="width=device-width, initial-scale=1">
        <title>Render fashion consulting services to costumers</title>
        <meta charset = "UTF-8" /> 
...
<strong class="name"> Welcome, <?=$_SESSION['username']?>!<br /></strong> <br />
     ...
     <center><h1>Render female native wears from your location</h1></center><br /><br />
      
     <div class="long">
         <form action="render-fashion-consulting-service1.php" method="post" enctype="multipart/form-data" autocomplete="off" class="">
