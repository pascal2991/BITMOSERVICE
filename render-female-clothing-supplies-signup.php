   ...
   <html> 
     <head>
          ...
          <title>Signup to start rendering female clothing supplies to clients around</title>
	      <meta charset = "UTF-8" /> 
...
<br />
  ...
  <a href="http://bitmoservice.com/render-female-clothing-supplies-login.php"> <input type="button" class="back" name="signin" value="Back"/></a>
  ...
  <div>
	...
	<div class="long">
   <form action="render-female-clothing-supplies-signup.php" method="post">
