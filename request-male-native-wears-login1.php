		...
		<html> 
				<head>
                        ...
                        <title>Request for male native wears on bitmoservice</title>
                        <meta charset = "UTF-8" /> 
 ...
 <br />
	 ...
	 <a href="http://bitmoservice.com/request-and-render-male-native-wears.php"> <input type="button" class="back" name="signin" value="Back"/></a>
				...
				<div class="long">
					 ...
					 <form action="request-male-native-wears-login1.php" method="post" class="iform">
			...
			<a  href="http://bitmoservice.com/request-male-native-wears-signup.php" ><input type="button" class="sig" value="Sign Up"></a>
