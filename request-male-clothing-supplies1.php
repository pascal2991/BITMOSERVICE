...
<!DOCTYPE html>
   ...
   <html> 
       ...
       <meta name="viewport" content="width=device-width, initial-scale=1">
        <title>Request for male clothing supplies from close by</title>
        <meta charset = "UTF-8" /> 
...
<body>
	 ...
	 <div id="contain">
      ...
      <center><h1>Place order for maleclothing supply </h1></center><br /><br />
      
     <div class="long">
         <form action="request-male-clothing-supplies1.php" method="post" enctype="multipart/form-data" autocomplete="off" class="">
