		...
		<html> 
				<head>
                        ...
                        <title>Render male native wears and services to customers around</title>
                        <meta charset = "UTF-8" /> 
 ...
 <br />
	 ...
	 <a href="http://bitmoservice.com/buy-and-sell-male-native-wears.php"> <input type="button" class="back" name="signin" value="Back"/></a>
				...
				<div class="long">
					 <form action="render-male-native-wears-login1.php" method="post" class="iform">
			...
			<a  href="http://bitmoservice.com/render-male-native-wears-signup.php" ><input type="button" class="sig" value="Sign Up"></a>
