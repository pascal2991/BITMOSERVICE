...
<!DOCTYPE html>
   ...
   <html> 
       ...
       <meta name="viewport" content="width=device-width, initial-scale=1">
        <title>Request for male clothing supplies close by</title>
        <meta charset = "UTF-8" /> 
...
<p id = 'name'>Please kindly fill the form.</p></div>
     ...
     <center><h1>Place order for male clothing suppiles </h1></center><br /><br />
      
     <div class="long">
         <form action="request-male-clothing-supplies.php" method="post" enctype="multipart/form-data" autocomplete="off" class="">
