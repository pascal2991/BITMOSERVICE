...
<br />
  ...
  <a href="http://bitmoservice.com/request-female-native-wears-login.php"> <input type="button" class="back" name="signin" value="Back"/></a>
  ...
  <div>
	...
	<div class="long">
   <form action="request-female-native-wears-signup.php" method="post">
