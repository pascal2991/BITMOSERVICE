		...
		<html> 
				<head>
                        ...
                        <title>Render female native wears and services to customers around</title>
                        <meta charset = "UTF-8" /> 
 ...
 <br />
	 ...
	 <a href="http://bitmoservice.com/buy-and-sell-female-native-wears.php"> <input type="button" class="back" name="signin" value="Back"/></a>
				...
				<div class="long">
					 ...
					 <form action="render-female-native-wears-login1.php" method="post" class="iform">
			...
			<a  href="http://bitmoservice.com/render-female-native-wears-signup.php" ><input type="button" class="sig" value="Sign Up"></a>
