   ...
   <html> 
     <head>
          ...
          <title>Signup to start rendering male clothing supplies to clients around</title>
	      <meta charset = "UTF-8" /> 
...
<br />
  ...
  <a href="http://bitmoservice.com/render-male-clothing-supplies-login.php"> <input type="button" class="back" name="signin" value="Back"/></a>
  ...
  <div>
	...
	<div class="long">
   <form action="render-male-clothing-supplies-signup.php" method="post">
