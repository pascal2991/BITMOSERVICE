...
<!DOCTYPE html>
   ...
   <html> 
       ...
       <meta name="viewport" content="width=device-width, initial-scale=1">
        <title>Render female native wears to costumers</title>
        <meta charset = "UTF-8" /> 
...
<strong class="name"> Welcome, <?=$_SESSION['username']?>!<br /></strong> <br />
     ...
     <div class="long">
         <form action="render-female-native-wears1.php" method="post" enctype="multipart/form-data" autocomplete="off" class="">
