...
<!DOCTYPE html>
   ...
   <html> 
       ...
       <meta name="viewport" content="width=device-width, initial-scale=1">
        <title>Request for female clothing supplies from close by</title>
        <meta charset = "UTF-8" /> 
...
<p id = 'name'>Please kindly fill the form.</p></div>
      ...
      <center><h1>Place order for femaleclothing supply </h1></center><br /><br />
      
     <div class="long">
         <form action="request-female-clothing-supplies1.php" method="post" enctype="multipart/form-data" autocomplete="off" class="">
