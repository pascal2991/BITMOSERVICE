   ...
   <html> 
       ...
       <meta name="viewport" content="width=device-width, initial-scale=1">
       	<title>Request and render male clothing supplies on bitmoservice</title>
	      <meta charset = "UTF-8" /> 
...
<div class= "contain1"> 
                ...
                <!-- <div class="right">
                            <img src = "buy-and-sell-male-fashion/male-fashion-bitmoservice.jpg"  width="width="110"" class="ideal" alt="miller-bitmoservice" >
                </div>  -->
<div class="input3w">

    <center><h1 class = "text3">Request and Render male clothing supplies from your location.</h1><br /><br /><br /></center>

    <div><a href="http://bitmoservice.com/request-male-clothing-supplies-login.php"><input id="input3x" type="button" value="Request" /></a></div>
    <br /><br/><br /><br /><br />

    <div><a href="http://bitmoservice.com/render-male-clothing-supplies-login.php"><input id="input3x" type="button" value="Render" /></a></div>
    <br /><br/><br /><br /><br />
