   ...
   <html> 
       ...
       <meta name="viewport" content="width=device-width, initial-scale=1">
       	<title>Request and render fashion consulting services on bitmoservice</title>
	      <meta charset = "UTF-8" /> 
...
<div class="input3w">
    ...
    <center><h1 class = "text3">Request and Render fashion consulting services from your location.</h1><br /><br /><br /></center>

    <div><a href="http://bitmoservice.com/request-fashion-consulting-service-login.php"><input id="input3x" type="button" value="Request" /></a></div>
    <br /><br/><br /><br /><br />

    <div><a href="http://bitmoservice.com/render-fashion-consulting-service-login.php"><input id="input3x" type="button" value="Render" /></a></div>
    <br /><br/><br /><br /><br />
