   ...
   <html> 
       ...
       <meta name="viewport" content="width=device-width, initial-scale=1">
       	<title>Request and render male native wears on bitmoservice</title>
	      <meta charset = "UTF-8" /> 
...
<div class="input3w">
    ...
    <center><h1 class = "text3">Request and Render male native wears from your location.</h1><br /><br /><br /></center>

    <div><a href="http://bitmoservice.com/request-male-native-wears-login.php"><input id="input3x" type="button" value="Request" /></a></div>
    <br /><br/><br /><br /><br />

    <div><a href="http://bitmoservice.com/render-male-native-wears-login.php"><input id="input3x" type="button" value="Render" /></a></div>
    <br /><br/><br /><br /><br />
