   ...
   <html> 
     <head>
          ...
          <title>Signup to start rendering male native wears to clients around</title>
	      <meta charset = "UTF-8" /> 
...
<br />
  ...
  <a href="http://bitmoservice.com/render-male-native-wears-login.php"> <input type="button" class="back" name="signin" value="Back"/></a>
  ...
  <div>
	...
	<div class="long">
   <form action="render-male-native-wears-signup.php" method="post">
