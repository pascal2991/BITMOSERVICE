...
<!DOCTYPE html>
   ...
   <html> 
       ...
       <meta name="viewport" content="width=device-width, initial-scale=1">
        <title>Render female clothing supplies to costumers</title>
        <meta charset = "UTF-8" /> 
...
<br />
     ...
     <center><h1>Render female clothing supplies from your location</h1></center><br /><br />
      
     <div class="long">
         <form action="render-female-clothing-supplies1.php" method="post" enctype="multipart/form-data" autocomplete="off" class="">
